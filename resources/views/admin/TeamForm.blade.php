                             ...
                             @error('image')
                                ...
                                @if (session('status'))
                                    <div class="alert alert-success mb-2 col-lg-6 offset-3 text-center">
                                        {{ session('status') }}</div>
                                @endif
                            <form class="separate-form" method="post" action="{{ url('AddTeam') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input name="name" class="form-control" type="text" placeholder="Enter name " id="member-name" value="@if(!empty($data)){{ $data->name }} @endif">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="member-name" class="col-form-label"> Mobile no. </label>
                                                <input name="phone" class="form-control" type="number" placeholder="Enter mobile no " id="member-name" value="@if(!empty($data)){{ $data->phone }} @endif">
                                            </div>
                                        </div>
                                         <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="member-name" class="col-form-label"> Designation </label>
                                                <input name="designation" class="form-control" type="text" placeholder="Enter designation  " id="member-name" value="@if(!empty($data)){{ $data->designation }} @endif">
                                            </div>
                                        </div>
                                       <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="image" class="form-control"  
                                                    id="member-name">
                                                @if(!empty($data))
                                                  <img src="{{ url('uploads/teams/' . $data->image) }}" alt=""  width="100" class="mt-2"> @endif"
                                            </div>
                                        </div>
                                    </div>
