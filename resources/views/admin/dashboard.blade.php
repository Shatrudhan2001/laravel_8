                ...
                <div class="colxl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-title-wrapper">
                        <div class="page-title-box">
                            <h4 class="page-title bold">{{ $title }}</h4>
                        </div>
                        <div class="breadcrumb-list">
                            <ul>
                                <li class="breadcrumb-link">
                                    <a href="{{ url('/dashboard') }}"><i class="fas fa-home mr-2"></i>{{ $title }}</a>
                                </li>
                        ...
                        <div class="card-body dd-flex align-items-center">
                            <div class="icon-info">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.126 512.126"
                                    xml:space="preserve">
                            ...
                            <div class="icon-info-text">
                                <h5 class="">Members</h5>
                                <h4 class="ad-card-title">{{ $user }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="card ad-info-card">
                        <div class="card-body dd-flex align-items-center">
                            ...
                            <div class="icon-info-text">
                                <h5 class="">Team</h5>
                                <h4 class="ad-card-title">{{ $team }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card ad-info-card">
                        <div class="card-body dd-flex align-items-center">
                            ...
                            <div class="icon-info-text">
                                ...
                                <h4 class="ad-card-title">{{ $subscriber }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="card ad-info-card">
                        <div class="card-body dd-flex align-items-center">
                            ...
                            <div class="icon-info-text">
                                <h5 class="">Events </h5>
                                <h4 class="ad-card-title">{{ $events }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
