                             ...
                             @error('image')
                                ...
                                @if (session('status'))
                                    <div class="alert alert-success mb-2 col-lg-6 offset-3 text-center">
                                        {{ session('status') }}</div>
                                @endif
                            <form class="separate-form" method="post" action="{{ url('addAbout') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input name="designation" class="form-control" type="text" placeholder="Enter Your Designation"
                                                    id="member-name">
                                            </div>
                                        </div> --}}
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="image" class="form-control"  
                                                    id="member-name">
                                                @if(!empty($data))
                                                  <img src="{{ url('uploads/abouts/' . $data->image) }}" alt=""  width="100" class="mt-2"> @endif"
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="additional-msg" class="col-form-label">Descriptions</label>
                                        <textarea name="description" class="form-control" id="additional-msg">@if(!empty($data)){{ $data->description }} @endif"</textarea>
                                    </div>
