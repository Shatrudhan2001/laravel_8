                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('addmultipleimage') }}" class="btn btn-success btn-sm"><i
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($photo_list as $item)
                                                        <tr>
                                                            <td>{{ $i++ }}</td>
                                                            <td>{{ $item->title }}</td>
                                                            <td><img src="{{ url('uploads/multipleimages/' . $item->image) }}" alt=""
                                                                    width="100">
                                                            </td>
                                                            <td>{{ date('d F Y',strtotime($item->created_at)) }}</td>
                                                            <td><a href="{{ url('edit-photo/' . $item->id) }}"
                                                                    class='btn btn-success'><i
                                                                        class=' far
                                                                                                                                                                                                                                                                                                                                                                                                                                                            fa-edit'></i></a>
                                                                <a href="{{ url('delete-photos/' . $item->id) }}"
