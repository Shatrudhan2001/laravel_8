                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('ManageAbout') }}" class="btn btn-success btn-sm"><i
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($about_list as $item)
                                                        <tr>
                                                            <td>{{ $i++ }}</td>
                                                            <td>{{ $item->title }}</td>
                                                            <td><img src="{{ url('uploads/abouts/' . $item->image) }}" alt=""
                                                                    width="100">
                                                            </td>
                                                            <td>{{ $item->created_at }}</td>
                                                            <td><a href="{{ url('edit-about/' . $item->id) }}"
                                                                    class='btn btn-success'><i
                                                                        class=' far
                                                                                                                                                                                                                                                                                                                                                                                                                                                            fa-edit'></i></a>
                                                                <a href="{{ url('delete-about/' . $item->id) }}"
