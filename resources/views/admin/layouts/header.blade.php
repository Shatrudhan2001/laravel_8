...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('admin/assets/css/icofont.min.css') }}">
...
<body>
    <!-- <div class="loader">
        <div class="spinner">
            <img src="{{ url('admin/assets/images/loader.gif') }}" alt="" />
        </div>
    </div> -->
    <!-- Main Body -->
                    ...
                    <div class="header-controls">
                        <div class="user-info-wrapper header-links">
                            <a href="javascript:void(0);" class="user-info">
                                <img src="{{ url('admin/assets/images/user.jpg') }}" alt="" class="user-img">
        ...
        <aside class="sidebar-wrapper">
            <div class="logo-wrapper">
                <a href="index.html" class="admin-logo">
                    <img src="{{ url('web/images/bsrs.png') }}" alt="" class="sp_logo" width="77px">
                    <img src="{{ url('web/images/bsrs.png') }}" alt="" class="sp_mini_logo">
